                    ...
                    <div class="col-lg-4" style="height: 30%; width: 10%;">
                        ...
                        <h5 class="text-truncate mb-3"><b><?php echo $row["name"];?></b></h5>
                                <div class="d-flex justify-content-center">
                                    <h6><?php echo $row["price"];?><del><?php echo $row["price"];?></del></h6>
                                </div>
                        </div>
                        <div class="card-footer d-flex justify-content-between bg-light border">
                                <h5 style="color:blueviolet;"><b>Free Delivery</b></h5>
                            </div>
                            <div class="card-footer d-flex justify-content-between bg-light border">
                                <h6>><?php echo $row["description"];?></h6>
                            </div>
                            <div class="card-header product-img position-relative overflow-hidden bg-transparent border p-0">
                                <img src="<?php echo $row["image"];?>" alt="" style="height:100%; width:100%;">
                            </div>
                            
                            <div class="card-body border-left border-right text-center p-0 pt-4 pb-3" id="order">
                                
                                <form method="POST" action="altshop.php?id=<?php echo $row['product_id'];?>">
                                    <input type="text" name="name" id="name" placeholder="Enter order..." value="<?php echo $row['name'];?>" readonly>
                    
                                    <input type="text" name="price" id="price" placeholder="Enter order..." value="<?php echo $row['price'];?>" readonly>
                                    
                                    <input type="text" name="quantity" id="quantity" placeholder="Enter order..." value="" >
                                    <input type="text" id="productid" name="productid" value=ID#<?php echo $row['product_id'];?> readonly>
                                <button class="btn btn-primary" type="submit" name="add_to_cart"><i class="fa fa-shopping-cart"></i></button>    
                                    </form>  
                                    </div>
